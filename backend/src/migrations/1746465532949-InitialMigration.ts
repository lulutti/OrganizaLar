...
export class InitialMigration1746465532949 implements MigrationInterface {
    name = 'InitialMigration1746465532949'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "cleaning_schedule_task" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "status" "public"."cleaning_schedule_task_status_enum" NOT NULL, "completedAt" TIMESTAMP WITH TIME ZONE, "cleaningScheduleId" uuid, "taskId" uuid NOT NULL, "assignedId" uuid, CONSTRAINT "PK_fe5af2bf7e1d0522c25c65c57a0" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "cleaning_schedule_task" ADD CONSTRAINT "FK_f65d9e58f43fe38108400fc54b7" FOREIGN KEY ("assignedId") REFERENCES "contributor"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "cleaning_schedule_task" DROP CONSTRAINT "FK_f65d9e58f43fe38108400fc54b7"`);
